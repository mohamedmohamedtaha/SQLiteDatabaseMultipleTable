...
public class ListViewAdaptorTODO extends BaseAdapter {
    private final LayoutInflater inflater;
    private final ArrayList<Todo>todos;

    public ListViewAdaptorTODO(Context context, ArrayList<Todo> todos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        showDateTag.setText(todos.get(position).getCreated_at());
        return view;
    }
}
