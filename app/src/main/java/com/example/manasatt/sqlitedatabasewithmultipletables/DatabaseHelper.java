...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String KEY_NOTE ="todo";
    ...
    private static final String CREATE_TABLE_TODO ="CREATE TABLE "
            + TABLE_TODO + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_NOTE
            + " TEXT," + KEY_STATUS + " INTEGER," + KEY_CREATED_AT
            + " DATETIME"+ ")";

    //Tag table cretae statement
    ...
    public void deleteTag (Todo tag,boolean should_delete_all_tag_todos) {
        ...
        if (should_delete_all_tag_todos) {
            ...
            List<Todo> allTagToDo = getAllToDosByTag(tag.getTag_name());
            //delete all todos
            for (Todo todo : allTagToDo) {
           //delete todo
    ...
    public long createToDo(Todo todo,long[]tag_ids){
        SQLiteDatabase db=this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(KEY_NOTE, todo.getNote());
    ...
    public ArrayList<Todo>getAllToDos(){
        ...
        String []colums = {KEY_ID,KEY_NOTE,KEY_STATUS,KEY_CREATED_AT};
        Cursor c = db.query(TABLE_TODO,colums,null,null,null,null,null);
        //looping through all rows and adding to list
        for (c.moveToFirst();!c.isAfterLast();c.moveToNext()){
                Todo td =new Todo();
                td.setId(c.getInt(c.getColumnIndex(KEY_ID)));
    ...
    public ArrayList<Todo>getAllToDosByTag(String tag_name){
        SQLiteDatabase db=this.getReadableDatabase();
        ArrayList<Todo> todos = new ArrayList<Todo>();
    ...
    //________________________________________________"todo_tags" table methods ___________________//
    ...
    public ArrayList<String> getDataForSpinner(){
        SQLiteDatabase db =this.getReadableDatabase();

        ArrayList<String> tags =new ArrayList<String>();
       // String []colums = {KEY_TAG_NAME};
